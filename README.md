...
`책찾사`는 `책을 찾아주는 사서`의 줄임말로 Discord를 통해 책을 검색하고, 북마크를 관리할 수 있는 강력한 도서 검색 봇입니다. 네이버 책 검색 API를 활용하여 원하는 도서를 손쉽게 찾고 관리할 수 있습니다.

---

## 📜 목차

1. [🛠️ 프로젝트 프로그램 설치방법](#프로젝트-프로그램-설치방법)
2. [📂 프로젝트 구성](#프로젝트-구성)
3. [🎮 프로젝트 프로그램 사용법](#프로젝트-프로그램-사용법)
   - [명령어 목록](#명령어-목록)
4. [🛡️ 저작권 및 사용권 정보](#️저작권-및-사용권-정보)
